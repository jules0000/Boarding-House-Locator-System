...
<head>
    ...
    <title>Boarding House Locator System - Dashboard</title>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                ...
                                <h6 class="text-muted">Lessees</h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                ...
                                <h6 class="text-muted">Lessors</h6>
                                <div class="progress progress-sm">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                ...
                                <h6 class="text-muted">No. of Boarding House</h6>
                                <div class="progress progress-sm">
                                    <div class="progress-bar bg-info w-50"></div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                ...
                                <h6 class="text-muted">No. of Transient</h6>
                                <div class="progress progress-sm">
                                    <div class="progress-bar bg-info w-50"></div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                ...
                                <h6 class="text-muted">No. of Bedspace</h6>
                                <div class="progress progress-sm">
                                    <div class="progress-bar bg-info w-50"></div>
                                </div>
                            </div>
