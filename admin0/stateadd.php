...
if(isset($_POST['insert']))
{
	...
	if(!empty($state)){
		...
		if($result)
			{
				$msg="<p class='alert alert-success'>Barangay Inserted Successfully</p>";
						
			}
			else
			{
				$error="<p class='alert alert-warning'>* Barangay Not Inserted</p>";
			}
	}
	else{
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Barangay</h3>
                        <ul class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title">Add Barangay</h1>
                            <?php echo $error;?>
                            <?php echo $msg;?>
                            <?php 
										if(isset($_GET['msg']))	
                        ...
                        <form method="post" id="insert product" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <h5 class="card-title">Barangay Details</h5>
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label">Barangay Name</label>
                                            <div class="col-lg-9">
