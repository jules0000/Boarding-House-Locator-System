                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Lessor</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Lessor List</h4>
                            <?php 
										if(isset($_GET['msg']))	
										echo $_GET['msg'];	
									?>
                            ...
                            <table id="basic-datatable" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Permit ID Picture</th>
                                        <th>Permit ID Number</th>
                                        <th>Status</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="user/<?php echo $row['permit_id_picture']; ?>" height="50px"
                                                width="50px"></td>
                                        <td><?php echo $row['permit_id_number']; ?></td>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["approve"])) {
        $lessorId = $_POST["approve"];
        mysqli_query($con, "UPDATE user SET status='approved' WHERE uid='$lessorId'");
    }

    if (isset($_POST["disapprove"])) {
        $lessorId = $_POST["disapprove"];
        mysqli_query($con, "UPDATE user SET status='disapproved' WHERE uid='$lessorId'");
    }
}
?>