    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown app-dropdown">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                <span class="user-img"><img class="rounded-circle" src="assets/img/profiles/logo.png" width="31"
                        alt="Admin"></span>
            </a>
            ...
            <div class="dropdown-menu">
                <div class="user-header">
                    <div class="avatar avatar-sm">
                        <img src="assets/img/profiles/logo.svg" alt="User Image" class="avatar-img rounded-circle">
                    </div>
                    <div class="user-text">
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <li><a href="adminlist.php"> Administrator </a></li>
                        <li><a href="userlist.php"> Lessees </a></li>
                        <li><a href="useragent.php"> Lessors </a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="stateadd.php"><i class="fe fe-home"></i> <span>Barangays</span></a>
                </li>
